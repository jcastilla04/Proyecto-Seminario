...
//esta condicion evalua los esenarios(causas) por la
//que un usuario no deberia entrar al DASHBOARD
if(!isset($_SESSION['login']) || (isset($_SESSION['login']) && !$_SESSION['login']['permitido'])){
    //TE VAS A TU CASA....
    header('Location:index.php');
}

$host = "http://localhost/ProyectoFinal";
?>
?>
<!DOCTYPE html>
<html lang="es">
    ...
    <body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <!-- Navbar Brand-->
            <a class="navbar-brand ps-3" href="<?= $host ?>/dashboard.php">App Seminario</a>
            <!-- Sidebar Toggle-->
            ...
            <ul class="navbar-nav ms-auto ms-md-0 me-3 me-lg-4">
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                        ...
                        <li><a class="dropdown-item" href="<?= $host ?>/controllers/usuario.controller.php?operacion=destroy">Cerrar Sesion</a></li>
                    </ul>
                </li>
            </ul>
        </nav>
                ...
                <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <a class="nav-link" href="<?= $host ?>/views/Reporte/">
                                <div class="sb-nav-link-icon"><i class="fas fa-table"></i></div>
                                Reportes
                            </a>
